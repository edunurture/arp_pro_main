...
const CompliancesReports = () => {
  ...
  const rows = useMemo(
    () => [
      { id: 1, reportId: 'CR001', reportName: 'AISHE Compliance Report' },
      { id: 2, reportId: 'CR002', reportName: 'RJD/DCE Statutory Report' },
      { id: 3, reportId: 'CR003', reportName: 'DOTE Regulatory Report' },
      { id: 4, reportId: 'CR004', reportName: 'UGC Compliance Report' },
      { id: 5, reportId: 'CR005', reportName: 'AICTE Annual Compliance Report' },
    ],
    [],
  )
  ...
  const onActionView = () => {
    ...
    // Report preview page
    window.open(`/reports/compliances/${selectedRow.reportId}`, '_blank')
  }

  const onActionPrint = () => {
    if (!selectedRow) return
    // Print-friendly preview page (hook print behavior in preview page)
    window.open(`/reports/compliances/${selectedRow.reportId}?print=1`, '_blank')
  }

  const onActionDownload = () => {
    if (!selectedRow) return
    // Static file path (replace with your actual static location)
    window.open(`/static/compliances-reports/${selectedRow.reportId}.pdf`, '_blank')
  }
      ...
      <CCol xs={12}>
        ...
        <CCard className="mb-3">
          <CCardHeader className="d-flex justify-content-between align-items-center">
            <strong>COMPLIANCES REPORTS</strong>
              ...
              <CRow className="g-3">
                ...
                <CCol md={3}>
                  ...
                  >
                    ...
                    <option value="RJD/DCE">RJD/DCE</option>
...
export default CompliancesReports
