...
const PROGRAMME_ROWS = [
  { id: 1, programme: 'Soft Skills Training', status: 'Active' },
  { id: 2, programme: 'Language & Communication', status: 'Active' },
  { id: 3, programme: 'Life Skills – Yoga', status: 'Inactive' },
  { id: 4, programme: 'Life Skills – Physical Fitness', status: 'Active' },
  { id: 5, programme: 'Awareness Of Trends In Technology', status: 'Active' },
]
...
const SkillEnhancement = () => {
  ...
  // Phase 3/4: Additional cards shown BELOW Phase 2 (this is what you asked)
  ...
  const rows = useMemo(() => PROGRAMME_ROWS, [])
  ...
  const onSavePhase4 = () => {
    ...
    console.log('SAVE Skill Enhancement (stub)', {
      ...
      <CCol xs={12}>
        ...
        <CCard className="mb-3">
          <CCardHeader className="d-flex justify-content-between align-items-center">
            <strong>STUDENT SUPPORT – CAPACITY DEVELOPMENT AND SKILL ENHANCEMENT</strong>
        ...
        {showTable && (
          <CCard className="mb-3">
            <CCardHeader className="d-flex justify-content-between align-items-center">
              <strong>Skill Enhancement Programmes</strong>
                  ...
                  <CTableHead>
                    <CTableRow>
                      ...
                      <CTableHeaderCell role="button" onClick={() => sortToggle('status')} style={{ userSelect: 'none' }}>
                        Status of Skill Enhancement Programme{sortIndicator('status')}
                      </CTableHeaderCell>
                    </CTableRow>
                  </CTableHead>
        ...
        {showTable && showPhase3 && (
          <CCard className="mb-3">
            <CCardHeader>
              <strong>Capacity Development And Skill Enhancement Activities</strong>
            </CCardHeader>
